/*
  # Ultra Clean Database Migration - No Constraints

  This migration creates the deployed_objects table with all necessary columns
  for the AR Viewer application without any problematic constraint syntax.

  ## What this migration does:
  1. Drops any problematic functions
  2. Creates the complete table structure
  3. Adds the missing updated_at column
  4. Sets up Row Level Security with proper policies
  5. Creates performance indexes
  6. Inserts sample data for testing

  ## What this migration does NOT do:
  - No ADD CONSTRAINT statements (these cause syntax errors)
  - No complex DO blocks for constraints
  - No IF NOT EXISTS with constraints
*/
